...
nsa1year = HPI_Data['NSA Value_left'].resample('A',how = 'mean')

print(nsa1year)
HPI_Data['nsa1year'] = nsa1year['NSA Value_left']
# print(HPI_Data)
print(HPI_Data[['nsa1year','NSA Value_left']])

HPI_Data['NSA Value_left'].plot(ax=ax1)
